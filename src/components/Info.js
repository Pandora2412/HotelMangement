                    ...
                    <Col xs = {{span: 12, order: 2}} sm = {{span: 12, order: 2}} md = {8} xl = {9}>
                        <Container fluid style = {{padding: '0'}}>
                            ...
                            <Row>
                                ...
                                <Col><Input.Normal type = "text" label = "Số CMND" placeholder = "Nhập số CMND" value = {info.ID} onChange = {handleChange} id = "ID"></Input.Normal></Col>
                            </Row>
                            <Row>
