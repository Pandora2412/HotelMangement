import '../../css/customer/Services.css';
import Gallery from '../../components/Khachhang/Gallery';
import nhahang1 from '../../Image/Customer/nhahang1.png';
import nhahang2 from '../../Image/Customer/nhahang2.png';
import hoboi1 from '../../Image/Customer/hoboi1.png';
import hoboi2 from '../../Image/Customer/hoboi2.png';
import bar1 from '../../Image/Customer/bar1.png';
import bar2 from '../../Image/Customer/bar2.png';
import spa1 from '../../Image/Customer/spa1.png';
import spa2 from '../../Image/Customer/spa2.png';
    ...
    return(
        <div className='dichvu'>
            <div className='nhahang'>
                <div className='row'>
                    <div className='col-5'>
                        <img src={nhahang1} className="img1" alt="nhahang1"></img>
                        </div>
                    <div className='col-7'>
                ...
                <img src={nhahang2} className="img2" alt="nhahang2"></img>
            </div>
            <div className='hoboi'>
                <div className='row'>
                    <div className='col-8'>
            ...
            <div className='bar'>
                <div className='row'>
                    <div className='col-5'>
                        <img src={bar1} className="img1" alt="bar1"></img>
                        </div>
                    <div className='col-7'>
                        <div className='description'>
                            <h1>BAR</h1>
                ...
                <img src={bar2} className="img2" alt="bar2"></img>
            </div>
            <div className='spa'>
                <div className='row'>
                    <div className='col-8'>
