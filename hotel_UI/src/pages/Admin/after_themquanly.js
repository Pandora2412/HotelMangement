...
class After_themquanly extends Component {
    render() {
        return (
            <div className="myForm">
                ...
                <div className="button1">
                    <Link to="/Khachhang/thaydoiquanly">
                        <img src={thaydoi} alt="" />
                    </Link>
                </div>
                <div className="button1">
                    <Link to="/Khachhang/quanly">
                        <img src={xoa} alt="" />
                    </Link>
                </div>
                <div className="button1">
                    <Link to="/Khachhang/trangthai">
...
export default After_themquanly;