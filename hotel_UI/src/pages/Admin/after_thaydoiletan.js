...
import them from '../../Image/them.png';
import { Link } from 'react-router-dom';

console.log(them);

class After_thaydoiletan extends Component {
    render() {
        return (
            <div>
                <Header></Header>
                <div className="add">
                    <Link to="/admin/addletan">
                        <img src={them} alt="" />
                    </Link>
                </div>
                <div className="row2" style={{marginTop: 40}}>
                ...
                <div className="row2">
                    <div className="name">Trần Ngọc U</div>
                    <div className="CCCD">100 000 000 019</div>
                    <div className="sdt">0909 000 019</div>
                    <div className="email">UTranNgoc@gmail.com</div>
                    <div className="username">100 000 000 019</div>
                    <div className="password">LT20</div>
                    <div className="trangthai">
                        <Link to="/admin/trangthai">Trạng thái</Link>
                    </div>
                    <div className="thaydoi">
...
export default After_thaydoiletan;