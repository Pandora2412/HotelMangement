                    ...
                    <Col xl={1} style={{textAlign: 'right'}}><button className="functionButton" onClick={() => {
                        const updateCustomer = async () => {
                            try {
                                ...
                                await axios.post(`/history/Lễ tân ${localStorage.getItem("username")} chỉnh sửa thông tin khách hàng ${id}.`);
                        ...
                        handleYes={() => {
                            const deleteCustomer = async () => {
                                try {
                                    ...
                                    await axios.post(`/history/Lễ tân ${localStorage.getItem("username")} xóa khách hàng ${id}.`);
